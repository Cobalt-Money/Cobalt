...
--> statement-breakpoint
CREATE INDEX "oauth_client_user_id_idx" ON "oauth_client" USING btree ("user_id");
--> statement-breakpoint
CREATE INDEX "oauth_client_client_id_idx" ON "oauth_client" USING btree ("client_id");
--> statement-breakpoint
CREATE INDEX "oauth_client_reference_id_idx" ON "oauth_client" USING btree ("reference_id");
--> statement-breakpoint
CREATE INDEX "oauth_refresh_token_client_id_idx" ON "oauth_refresh_token" USING btree ("client_id");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "oauth_refresh_token_session_id_idx" ON "oauth_refresh_token" USING btree ("session_id");
--> statement-breakpoint
CREATE INDEX "oauth_access_token_client_id_idx" ON "oauth_access_token" USING btree ("client_id");
--> statement-breakpoint
CREATE INDEX "oauth_access_token_user_id_idx" ON "oauth_access_token" USING btree ("user_id");
--> statement-breakpoint
CREATE INDEX "oauth_access_token_reference_id_idx" ON "oauth_access_token" USING btree ("reference_id");
--> statement-breakpoint
CREATE INDEX "oauth_access_token_refresh_id_idx" ON "oauth_access_token" USING btree ("refresh_id");
--> statement-breakpoint
CREATE INDEX "oauth_access_token_session_id_idx" ON "oauth_access_token" USING btree ("session_id");
--> statement-breakpoint
CREATE INDEX "oauth_consent_client_user_idx" ON "oauth_consent" USING btree ("client_id", "user_id");
--> statement-breakpoint
CREATE INDEX "oauth_consent_reference_id_idx" ON "oauth_consent" USING btree ("reference_id");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE POLICY "app_full_access" ON "oauth_client" AS PERMISSIVE FOR ALL TO "pg_write_all_data" USING (true) WITH CHECK (true);
--> statement-breakpoint
CREATE POLICY "app_full_access" ON "oauth_refresh_token" AS PERMISSIVE FOR ALL TO "pg_write_all_data" USING (true) WITH CHECK (true);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE POLICY "app_full_access" ON "oauth_access_token" AS PERMISSIVE FOR ALL TO "pg_write_all_data" USING (true) WITH CHECK (true);
--> statement-breakpoint
CREATE POLICY "agent_select_own" ON "oauth_access_token" AS PERMISSIVE FOR SELECT TO "pg_read_all_data" USING (current_setting('request.jwt.claims', true) IS NULL OR "user_id" = (SELECT (current_setting('request.jwt.claims', true)::json->>'sub')));
--> statement-breakpoint
CREATE POLICY "app_full_access" ON "oauth_consent" AS PERMISSIVE FOR ALL TO "pg_write_all_data" USING (true) WITH CHECK (true);
--> statement-breakpoint
CREATE POLICY "agent_select_own" ON "oauth_consent" AS PERMISSIVE FOR SELECT TO "pg_read_all_data" USING (current_setting('request.jwt.claims', true) IS NULL OR "user_id" = (SELECT (current_setting('request.jwt.claims', true)::json->>'sub')));
--> statement-breakpoint
CREATE POLICY "app_full_access" ON "jwks" AS PERMISSIVE FOR ALL TO "pg_write_all_data" USING (true) WITH CHECK (true);
