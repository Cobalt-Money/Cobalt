...
export interface components {
  schemas: {
    ...
    Transaction: {
      ...
      /**
       * @description Institution-provided merchant logo URL when available. Null when unreported. Prefer this over rendering `website` through a third-party favicon service.
      ...
      tagIds: string[];
      /**
       * @description Merchant website when reported by the institution. Bare domain, no scheme. Use to resolve a brand logo when `logoUrl` is null.
       * @example uber.com
       */
      website: string | null;
    };
    ...
    RecurringStreamStatus:
      "UNKNOWN" | "MATURE" | "EARLY_DETECTION" | "TOMBSTONED" | null;
    /**
