...
/**
 * Workflow: Handle ACCOUNT_TRANSACTIONS_INITIAL_UPDATE webhook
 * Fetches ALL transactions with pagination (initial sync)
 */
...
/**
 * Workflow: Handle ACCOUNT_TRANSACTIONS_UPDATED webhook
 * Fetches incremental transactions since last sync
 */
export async function snaptradeTransactionsUpdatedWorkflow(
  ...
  try {
    ...
    let { activityCount } = incrementalResult;
