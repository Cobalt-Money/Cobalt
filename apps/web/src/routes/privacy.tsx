        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              ...
              <li>
                <strong>Financial Account Information:</strong> Financial institution names, account
                types, account balances, transaction history, and related financial data (obtained
                securely through authorized third-party connection services)
              </li>
              <li>
                <strong>Usage Data:</strong> Information about how you interact with our Services,
                including features accessed, preferences set, and time spent on the platform
              </li>
              <li>
                <strong>Communication Records:</strong> Records of your correspondence with our
                support team, including emails, chat logs, and feedback submissions
              </li>
              <li>
                <strong>Technical Information:</strong> Device information, IP address, browser
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              ...
              <li>
                To display your aggregated financial data, account balances, and transaction
                histories
              </li>
              <li>To generate personalized financial insights, analytics, and visualizations</li>
            ...
            <p className="text-foreground/85 mb-4">
              ...
              and account modifications, must be conducted directly through your financial
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              ...
              <li>
                <strong>Conversational Interface:</strong> AI-powered chat functionality to answer
                questions about your financial data and provide guidance
              </li>
              <li>
                <strong>Predictive Analytics:</strong> Generation of financial forecasts, budget
                projections, and cash flow predictions based on your historical data
              </li>
              <li>
                <strong>Anomaly Detection:</strong> Identification of unusual transactions, spending
                spikes, or potential issues requiring your attention
              </li>
              <li>
                <strong>Personalized Recommendations:</strong> Customized suggestions for budgeting,
                saving, and financial management based on your unique financial profile
              </li>
              <li>
                <strong>Continuous Improvement:</strong> Enhancement of model accuracy and relevance
                through systematic evaluation of system performance
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              ...
              <li>
                <strong>Account Privacy:</strong> Your financial conversations, transactions, and
                data remain strictly private to your account
              </li>
              <li>
                <strong>Aggregated Insights Only:</strong> Any improvements to our AI models based
                on user interactions are implemented at an aggregate, anonymized system level that
                does not expose or share individual user patterns, behaviors, or information
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              ...
              <li>
                Your data is not stored, retained, or persisted by these providers after your
                request is fulfilled
              </li>
              <li>
                Your data is not used for training, fine-tuning, or improving these providers&apos;
                AI models
              </li>
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              ...
              <li>
                Each provider is required to provide the same or equal protection of your data as
                described in this Privacy Policy
              </li>
              <li>
                We carefully vet all AI service providers to ensure they meet our stringent privacy
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              <li>
                ...
                constitute professional financial advice, investment recommendations, or tax
                guidance
              </li>
              <li>
                <strong>Verification Recommended:</strong> We strongly encourage you to
                independently verify all AI-generated information and consult with qualified
                financial advisors, accountants, or other licensed professionals before making
                significant financial decisions
              </li>
              <li>
                <strong>Explanation Available:</strong> You may contact us at any time to understand
                how AI was utilized in generating any particular recommendation, insight, or
                analysis
              </li>
              <li>
                <strong>Human Oversight:</strong> While our AI systems are sophisticated, they may
                occasionally produce errors or unexpected results. We continuously monitor and
                improve our AI functionality
              </li>
            </ul>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              ...
              <li>
                <strong>Access Restrictions:</strong> Access to sandbox environments is strictly
                limited to authorized Cobalt engineering and operations personnel on a need-to-know
                basis
              </li>
              <li>
                <strong>Security Controls:</strong> Sandbox environments are protected by the same
                or greater security controls as production systems, including encryption, access
                logging, and network isolation
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              ...
              <li>
                It is periodically refreshed or purged to ensure data freshness and minimize
                retention
              </li>
              <li>
                It is never shared with third parties, used for marketing purposes, or processed for
                any use case outside of development and testing
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              ...
              <li>
                <strong>No Persistence:</strong> Your data is not stored, logged, cached, or
                retained by these providers after your request is completed
              </li>
              <li>
                <strong>No Training Use:</strong> Your data is not used to train, fine-tune,
                evaluate, or improve the third-party provider's models or services
              </li>
              <li>
                <strong>Contractual Guarantees:</strong> All ZDR provisions are contractually
                enforced through our agreements with these third-party providers
              </li>
              <li>
                <strong>Encrypted Transit:</strong> All data transmitted to ZDR providers is
                encrypted in transit using industry-standard protocols (TLS 1.2 or higher)
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              ...
              <li>
                <strong>Access Controls:</strong> Role-based access restrictions limiting employee
                access to personal information on a need-to-know basis
              </li>
              <li>
                <strong>Authentication:</strong> Multi-factor authentication options and strong
                password requirements
              </li>
              <li>
                <strong>Security Audits:</strong> Regular internal and third-party security
                assessments, vulnerability testing, and penetration testing
              </li>
              <li>
                <strong>Monitoring:</strong> Continuous monitoring systems to detect and respond to
                potential security incidents
              </li>
              <li>
                <strong>Incident Response:</strong> Established procedures for responding to and
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              ...
              <li>Modify sync preferences to control how frequently financial data is updated</li>
              <li>
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              <li>
                ...
                content, within thirty (30) days of your deletion request
              </li>
              <li>
                <strong>Irreversibility:</strong> Once the deletion process is complete, your data
                cannot be recovered, restored, or reinstated
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              ...
              <li>
                <strong>Communication Records:</strong> Customer support tickets, emails, and other
                communications retained for up to three (3) years for quality assurance, training,
                dispute resolution, and legal purposes
              </li>
              <li>
                <strong>Legal Obligations:</strong> Information retained as required by applicable
                laws, regulations, court orders, or government requests
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              ...
              <li>
                ...
                directly to the third-party service (not to Cobalt)
              </li>
              <li>
              ...
              <li>
                These services retrieve your financial data (account balances, transactions, account
                details) and securely transmit it to Cobalt for display within our platform
              </li>
              <li>
                Each third-party service is subject to its own privacy policy and security
                standards, which we encourage you to review
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              ...
              <li>Protect the rights, property, or safety of Cobalt, our users, or the public</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-foreground/85 mb-4 space-y-1">
              ...
              <li>
                Remove individual data points or categories of information as supported by the
                platform
              </li>
            </ul>
