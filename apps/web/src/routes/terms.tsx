        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              ...
              agreement between you and Cobalt Personal Finance Inc. ("Cobalt,"
              "we," "us," or "our") governing your access to and use of our
              personal finance management platform and related services
            ...
            <p className="text-gray-300 mb-4">
              ...
              continued use of the Services after any such modifications
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
              ...
              <li>
                All information you provide to us is accurate, current, and
                complete
              </li>
            </ul>
            <p className="text-gray-300 mb-4">
              If you are accessing the Services on behalf of an organization,
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              Cobalt is a personal finance management platform that provides
              AI-powered insights, account aggregation, transaction tracking,
              and financial planning tools. Our Services include:
            </p>
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
              <li>
                Secure, read-only connection to your financial accounts through
                authorized third-party services
              </li>
              <li>
                Aggregation and display of your financial data, including
                account balances, transactions, and transaction history
              </li>
              <li>
                AI-powered financial analysis, spending pattern identification,
                and personalized recommendations
              </li>
              <li>
                Conversational AI interface for querying and analyzing your
                financial data
              </li>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold font-manrope mb-4">
              4. NO FINANCIAL TRANSACTION AUTHORITY
            </h2>
            <p className="text-gray-300 mb-4">
              <strong>IMPORTANT LIMITATION:</strong> Cobalt is a financial
              information and analysis platform only. We do NOT:
            </p>
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
              <li>
                Process, execute, facilitate, or authorize any financial
                transactions
              </li>
              <li>Transfer funds between accounts</li>
              <li>Make payments on your behalf</li>
              <li>
                Modify account balances or settings at financial institutions
              </li>
              <li>
                Act as a bank, broker, investment advisor, or financial
                institution
              </li>
            </ul>
            <p className="text-gray-300 mb-4">
              Our Services are designed exclusively to help you view, track,
              analyze, and manage your financial information. All financial
              transactions, including payments, transfers, deposits,
              withdrawals, and account modifications, must be conducted directly
              through your financial institutions or their authorized platforms.
            </p>
            <p className="text-gray-300 mb-4">
              We maintain read-only access to your financial accounts through
              authorized third-party connection services and cannot and will not
              initiate any transactions on your behalf.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold font-manrope mb-4">
              5. AI SERVICES AND DISCLAIMERS
            </h2>
            ...
            <p className="text-gray-300 mb-4">
              Our Services utilize artificial intelligence and machine learning
              technologies, including third-party AI models from Anthropic
              Claude and Alibaba Qwen, to provide:
            </p>
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
            ...
            <p className="text-gray-300 mb-4">
              <strong>CRITICAL DISCLAIMER:</strong> All AI-generated insights,
              recommendations, analyses, predictions, and suggestions provided
              through the Services are for informational and educational
            ...
            <p className="text-gray-300 mb-4">
              You should NOT rely solely on AI-generated content for making
              significant financial, investment, tax, or legal decisions. We
              strongly recommend that you:
            </p>
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
              <li>Independently verify all AI-generated information</li>
              <li>
                Consult with qualified, licensed financial advisors,
                accountants, tax professionals, or attorneys before making
            ...
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
              <li>
                AI systems may produce errors, inaccuracies, or unexpected
                results
              </li>
              <li>
              ...
              <li>
                AI recommendations are based on patterns in your data and may
                not account for all relevant factors
              </li>
              <li>
                Past performance and patterns do not guarantee future results
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              To connect your financial accounts to our platform, we utilize
              authorized third-party financial data aggregation services,
              including:
            </p>
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
              <li>Plaid Inc.</li>
            ...
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
              <li>
                You provide your financial institution credentials directly to
                these third-party services, not to Cobalt
              </li>
              <li>
            ...
            <p className="text-gray-300 mb-4">
              We utilize third-party AI models and services, including Anthropic
              Claude and Alibaba Qwen, to power certain AI features. Your
              financial data may be transmitted to these providers in accordance
              with our Privacy Policy and their respective data handling
              practices.
            </p>

            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">
              6.3 No Endorsement or Liability
            </h3>
            <p className="text-gray-300 mb-4">
              We do not endorse, guarantee, or assume responsibility for any
              third-party services, products, or content. Your use of
              third-party services is at your sole risk, and you should review
              their terms and privacy policies before use.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              ...
              when creating your account and using the Services, and to promptly
            ...
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
              ...
              <li>
                Use any automated systems (bots, scrapers, etc.) to access the
              ...
              <li>
                Remove, circumvent, disable, damage, or interfere with
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              You retain all ownership rights to the financial data, documents,
              and other content you upload, store, or generate through the
              Services ("User Content"). By providing User Content to the
              Services, you grant us a limited, non-exclusive, royalty-free
              license to use, store, process, and display such content solely
            ...
            <p className="text-gray-300 mb-4">
              ...
              third-party connection services, we do not guarantee the accuracy,
              completeness, or timeliness of financial information obtained from
              third-party sources. You are responsible for verifying the
            ...
            <p className="text-gray-300 mb-4">
              While we implement backup procedures, you are solely responsible
              for maintaining independent backups of important financial
              documents and records. We are not responsible for any loss or
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">
              9.1 Cobalt's Ownership
            </h3>
            <p className="text-gray-300 mb-4">
              The Services, including all software, technology, features,
              functionality, content, designs, graphics, interfaces, and
              trademarks, are owned by Cobalt Personal Finance Inc. and are
            ...
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
              ...
              <li>
                Use the Services for any commercial purpose without our written
                consent
              </li>
            </ul>
            ...
            <p className="text-gray-300 mb-4">
              ...
              regarding the Services, you grant us an unrestricted, perpetual,
              irrevocable, royalty-free license to use, modify, and incorporate
              such feedback into our Services without any obligation to you.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              ...
              information as described in our Privacy Policy. By using the
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
              <li>
                ...
                information, content, or data provided through the Services
              </li>
              <li>
              ...
              <li>
                That the Services are free from viruses or other harmful
                components
              </li>
            ...
            <p className="text-gray-300 mb-4">
              Financial data obtained from third-party services may be delayed,
              inaccurate, or incomplete. We are not responsible for errors or
              omissions in data provided by third-party financial institutions
              or data aggregation services.
            </p>
            ...
            <p className="text-gray-300 mb-4">
              ...
              TO YOUR DEVICE, LOSS OF DATA, OR OTHER HARM RESULTING FROM YOUR
              USE OF THE SERVICES.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              IN NO EVENT SHALL COBALT PERSONAL FINANCE INC., ITS OFFICERS,
            ...
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
              ...
              <li>
                Damages arising from errors, omissions, interruptions,
                deletions, defects, delays in operation or transmission, or any
            ...
            <p className="text-gray-300 mb-4">
              ...
              COBALT HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
            </p>
            <p className="text-gray-300 mb-4">
              IN NO EVENT SHALL OUR TOTAL LIABILITY TO YOU FOR ALL DAMAGES,
              LOSSES, AND CAUSES OF ACTION EXCEED THE AMOUNT YOU HAVE PAID TO
              COBALT IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM, OR ONE
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              You agree to indemnify, defend, and hold harmless Cobalt Personal
              Finance Inc., its officers, directors, employees, agents,
            ...
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
              ...
              <li>
                Any decisions you make based on information provided through the
                Services
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              ...
              guarantee uninterrupted or error-free access to the Services. We
              may temporarily suspend, restrict, or terminate access to all or
            ...
            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">
              14.2 Modifications to Services
            </h3>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              Upon termination, your personal data will be deleted in accordance
              with our Privacy Policy (typically within 30 days).
            </p>

            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">
              15.2 Termination by Cobalt
            </h3>
            <p className="text-gray-300 mb-4">
              We reserve the right to suspend or terminate your account and
              access to the Services immediately, without prior notice or
            ...
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
              ...
              <li>
                We may delete your account and User Content in accordance with
                our Privacy Policy
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              ...
              these Terms or the Services shall be resolved through:
            </p>
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
              <li>
                <strong>Informal Resolution:</strong> You agree to first contact
                us at feedback@try-cobalt.com to attempt to resolve any dispute
                informally
              </li>
              <li>
                <strong>Jurisdiction:</strong> If informal resolution is
                unsuccessful, you agree that any legal action or proceeding
                shall be brought exclusively in the federal or state courts
                located in New York County, New York, and you consent to the
            ...
            <p className="text-gray-300 mb-4">
              ...
              proceeds in court rather than through alternative dispute
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              ...
              entire agreement between you and Cobalt regarding the Services and
            ...
            <p className="text-gray-300 mb-4">
              ...
              is created between you and Cobalt as a result of these Terms or
            ...
            <p className="text-gray-300 mb-4">
              ...
              beyond our reasonable control, including acts of God, natural
              disasters, war, terrorism, riots, pandemics, labor disputes, or
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              Your continued use of the Services after any modifications to
              these Terms constitutes your acceptance of the revised Terms. If
