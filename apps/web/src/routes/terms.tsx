  ...
  return (
    <div className="h-svh overflow-y-auto bg-black text-white">
      <div className="container mx-auto px-6 py-16 max-w-4xl">
        <h1 className="text-4xl font-bold font-manrope mb-8">Terms of Service</h1>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold font-manrope mb-4">1. ACCEPTANCE OF TERMS</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold font-manrope mb-4">2. ELIGIBILITY</h2>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold font-manrope mb-4">3. DESCRIPTION OF SERVICE</h2>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">You acknowledge and agree that:</p>
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold font-manrope mb-4">6. THIRD-PARTY SERVICES</h2>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">7.1 Account Security</h3>
            ...
            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">7.3 Prohibited Conduct</h3>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold font-manrope mb-4">8. USER CONTENT AND DATA</h2>

            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">8.1 Your Data</h3>
            <p className="text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">8.2 Data Accuracy</h3>
            <p className="text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">8.3 Data Backup</h3>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold font-manrope mb-4">9. INTELLECTUAL PROPERTY</h2>

            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">9.1 Cobalt's Ownership</h3>
            <p className="text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">9.2 Limited License</h3>
            <p className="text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">9.3 Feedback</h3>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold font-manrope mb-4">10. DATA AND PRIVACY</h2>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">11.1 "AS IS" Service</h3>
            <p className="text-gray-300 mb-4">
            ...
            <p className="text-gray-300 mb-4">WE DO NOT WARRANT OR GUARANTEE:</p>
            <ul className="list-disc list-inside text-gray-300 mb-4 space-y-1">
              <li>
            ...
            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">11.3 Third-Party Data</h3>
            <p className="text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">11.4 Your Sole Risk</h3>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW:</p>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold font-manrope mb-4">13. INDEMNIFICATION</h2>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold font-manrope mb-4">15. TERMINATION</h2>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">16.1 Governing Law</h3>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold font-manrope mb-4">17. GENERAL PROVISIONS</h2>

            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">17.1 Entire Agreement</h3>
            <p className="text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">17.2 Severability</h3>
            <p className="text-gray-300 mb-4">
              If any provision of these Terms is found to be invalid or unenforceable, the remaining
              provisions shall remain in full force and effect.
            </p>

            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">17.3 Waiver</h3>
            <p className="text-gray-300 mb-4">
              Our failure to enforce any right or provision of these Terms shall not be deemed a
              waiver of such right or provision.
            </p>

            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">17.4 Assignment</h3>
            <p className="text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">17.5 No Agency</h3>
            <p className="text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold font-manrope mb-3 mt-6">17.6 Force Majeure</h3>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold font-manrope mb-4">18. CHANGES TO TERMS</h2>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold font-manrope mb-4">19. CONTACT INFORMATION</h2>
            <p className="text-gray-300 mb-4">
