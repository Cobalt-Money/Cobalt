// askUser disabled — sequential-asking loop. Re-enable: restore imports,
// PendingQuestions block, and <PendingQuestions /> render below.
...
export function ChatInputDock() {
  ...
  const { chatId: _chatId } = params;
  const { queuedMessages, removeFromQueue, updateInQueue } = useChat();

  return (
    <div className="flex w-full flex-col">
      {/* {_chatId && <PendingQuestions chatId={_chatId} />} */}
