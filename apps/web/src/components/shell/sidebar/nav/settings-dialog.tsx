...
export function SettingsDialog({
  ...
  return (
    <Dialog onOpenChange={handleOpenChange} open={open}>
      <DialogContent
        className="top-[max(6rem,13svh)] flex h-[640px] w-[768px] max-w-[calc(100vw-2rem)] translate-y-0 flex-col gap-0 overflow-hidden border-0 bg-[oklch(0.949_0_0)] p-0 shadow-2xl sm:max-w-3xl dark:bg-[oklch(0.29_0_0)]"
