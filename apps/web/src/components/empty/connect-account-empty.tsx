 ...
 */
export function ConnectAccountEmpty(props: Omit<ConnectAccountEmptyProps, "onConnect">) {
  const { openAddAccount } = useCommandMenu();
  return <ConnectAccountEmptyPresentational {...props} onConnect={openAddAccount} />;
}
